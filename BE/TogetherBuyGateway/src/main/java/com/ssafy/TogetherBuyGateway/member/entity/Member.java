...
import com.ssafy.TogetherBuyGateway.global.domain.community.entity.comment.Comment;
import com.ssafy.TogetherBuyGateway.global.domain.community.entity.freeBoard.FreeBoard;
import com.ssafy.TogetherBuyGateway.global.domain.community.entity.freeBoard.FreeBoardLike;
import com.ssafy.TogetherBuyGateway.global.domain.community.entity.groupBuyingBoard.GroupBuyingBoard;
import com.ssafy.TogetherBuyGateway.global.domain.community.entity.groupBuyingBoard.GroupBuyingBoardLike;
import com.ssafy.TogetherBuyGateway.global.domain.shop.entity.common.Apply;
import com.ssafy.TogetherBuyGateway.global.domain.shop.entity.product.Product;
import com.ssafy.TogetherBuyGateway.member.dto.request.MemberRegisterRequestDTO;
...
public class Member {
    ...
    public void signup(MemberRegisterRequestDTO requestDTO, MemberLocation memberLocation, MemberImage profileImage) {
        this.nickname = requestDTO.nickname();
        this.birth = requestDTO.birth();
        this.gender = requestDTO.gender();
        this.memberLocations.add(memberLocation);
        this.bank = requestDTO.bankName();
        this.account = requestDTO.bankNumber();
