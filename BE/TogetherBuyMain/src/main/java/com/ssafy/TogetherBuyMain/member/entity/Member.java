...
//    private LocalDateTime birth;
    ...
    public void signup(MemberRegisterRequestDTO requestDTO, MemberLocation memberLocation, MemberImage profileImage) {
        ...
        this.gender = Objects.equals(requestDTO.gender(), "MALE") ? 1 : 0;
        this.memberLocations.add(memberLocation);
        this.bank = requestDTO.bankName();
        this.account = requestDTO.bankNumber();
        this.profileImage = profileImage;
        this.tel = requestDTO.tel();
        this.memberPoint = MemberPoint.builder()
                .member(this)
                .balance(0L)
                .build();
    }
    ...
    // Member.java
    public void updateMemberInfo(String nickname, String tel, LocalDate birth, Integer gender, String bank, String account) {
        this.nickname = nickname;
        this.tel = tel;
        this.birth = birth;
        this.gender = gender;
    ...
    public void purchase(Long amount) {
        ...
        if (memberPoint.getBalance() < amount) {
