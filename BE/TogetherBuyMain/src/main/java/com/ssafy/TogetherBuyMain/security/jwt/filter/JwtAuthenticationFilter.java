package com.ssafy.TogetherBuyMain.security.jwt.filter;
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
        ...
        if (providerId != null && SecurityContextHolder.getContext().getAuthentication() != null) {
            ...
            if (tokenMemberId.equals(member.getMemberId())) {
                ...
                String[] tokens = jwtService.generateTokenArray(updatedMember);
                ...
                jwtUtil.addTokenInCookie(response, "Refresh-Token", newRefreshToken, 86400);  // 예: 24시간 유효
