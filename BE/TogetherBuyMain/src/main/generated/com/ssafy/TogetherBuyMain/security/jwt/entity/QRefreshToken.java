package com.ssafy.TogetherBuyMain.security.jwt.entity;
...
public class QRefreshToken extends EntityPathBase<RefreshToken> {
    ...
    private static final long serialVersionUID = -1158998492L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QRefreshToken refreshToken1 = new QRefreshToken("refreshToken1");

    public final NumberPath<Long> expiry = createNumber("expiry", Long.class);

    public final NumberPath<Long> id = createNumber("id", Long.class);

    public final com.ssafy.TogetherBuyMain.member.entity.QMember member;

    public final EnumPath<com.ssafy.TogetherBuyMain.member.entity.Provider> provider = createEnum("provider", com.ssafy.TogetherBuyMain.member.entity.Provider.class);
