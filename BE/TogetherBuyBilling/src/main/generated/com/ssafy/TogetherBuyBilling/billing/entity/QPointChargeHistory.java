...
public class QPointChargeHistory extends EntityPathBase<PointChargeHistory> {
    ...
    private static final long serialVersionUID = -714799504L;
    ...
    public final com.ssafy.TogetherBuyBilling.member.entity.QPoint point;
    ...
    public QPointChargeHistory(Class<? extends PointChargeHistory> type, PathMetadata metadata, PathInits inits) {
        ...
        this.point = inits.isInitialized("point") ? new com.ssafy.TogetherBuyBilling.member.entity.QPoint(forProperty("point"), inits.get("point")) : null;
    }
