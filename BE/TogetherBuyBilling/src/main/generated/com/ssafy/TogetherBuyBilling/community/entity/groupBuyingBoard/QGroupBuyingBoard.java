...
public class QGroupBuyingBoard extends EntityPathBase<GroupBuyingBoard> {
    ...
    private static final long serialVersionUID = 561988928L;
    ...
    public final com.ssafy.TogetherBuyBilling.shop.entity.common.QForm form;
    ...
    public QGroupBuyingBoard(Class<? extends GroupBuyingBoard> type, PathMetadata metadata, PathInits inits) {
        ...
        this.form = inits.isInitialized("form") ? new com.ssafy.TogetherBuyBilling.shop.entity.common.QForm(forProperty("form"), inits.get("form")) : null;
