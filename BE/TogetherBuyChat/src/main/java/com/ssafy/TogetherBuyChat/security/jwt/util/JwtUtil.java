package com.ssafy.TogetherBuyChat.security.jwt.util;
...
import com.ssafy.TogetherBuyChat.security.jwt.handler.JwtException;
...
public class JwtUtil {
    ...
    public String generateAccessToken(Member member) {
        ...
        claims.put("memberPoint", member.getMemberPoint() != null ? member.getMemberPoint().getBalance() : 0L);
